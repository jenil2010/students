    ...
    <div class="col-12">
        ...
        <div class="bs-stepper vertical wizard-modern wizard-modern-vertical mt-2">
            ...
            <div class="bs-stepper-content m-5">
                <form action="{{ route('addmission.update',$addmission->id) }}" method="POST" id="num" enctype="multipart/form-data">
                    @csrf
                    <!-- Account Details -->
                            ...
                            <div class="col-sm-4">
                                <div class="form-floating form-floating-outline ">
                                    <input type="text" class="form-control" id="first_name" placeholder="First Name"
                                        name="first_name" value="{{ old('first_name',$addmission->first_name) }}">
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="form-floating form-floating-outline ">
                                    <input type="text" class="form-control" id="middle_name" placeholder="First Name"
                                        name="middle_name" value="{{ old('middle_name',$addmission->middle_name) }}">
                            ...
                            <div class="col-sm-4">
                                <div class="form-floating form-floating-outline ">
                                    <input type="text" class="form-control" id="last_name" placeholder="Last Name"
                                        name="last_name" value="{{ old('last_name',$addmission->last_name) }}">
                            ...
                            <div class="col-sm-4">
                                <div class="form-floating form-floating-outline ">
                                    <input type="number" class="form-control" id="phone" placeholder="Mobile Number"
                                        name="phone" maxlength="10" pattern="\d{10}" value="{{ old('phone',$addmission->phone) }}">
                            ...
                            <div class="col-sm-4">
                                <div class="form-floating form-floating-outline ">
                                    <input type="email" id="email" class="form-control" placeholder="Email"
                                        name="email" value="{{ old('email',$addmission->email) }}">
                            ...
                            <div class="col-sm-4">
                                <div class="form-floating form-floating-outline ">
                                    ...
                                    <input type="hidden" class="form-control flatpickr-validation flatpickr-input"
                                        ...
                                        value="{{ old('dob',$addmission->dob) }}" id="dobs">
                            ...
                            <div class="col-sm-4">
                                <div class="form-floating form-floating-outline ">
                                    <select class="form-select" id="gender" name="gender">
                                        ...
                                        <option value="male" {{ old('gender',$addmission->gender) === 'male' ? 'selected' : '' }}>Male
                                        </option>
                                        <option value="female" {{ old('gender',$addmission->gender) === 'female' ? 'selected' : '' }}>Female
                                        </option>
                                    </select>
                                ...
                                <div class="form-floating form-floating-outline ">
                                    <select class="form-select select2" id="country_id" name="country_id">
                                        ...
                                        @foreach ($country as $item)
                                            <option value="{{ $item->id }}" {{ old('country_id',$addmission->country_id) === $item->id ? 'selected' : '' }}>{{ $item->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-sm-12">
                                <div class="form-floating form-floating-outline ">
                                    <textarea class="materialize-textarea form-control h-px-75 resize-none" id="address" name="address"
                                        placeholder="Address" rows="3" >{{ old('address',$addmission->address) }}</textarea>
                                ...
                                <div class="form-floating form-floating-outline ">
                                    <select class="form-select select2" id="village" name="village">
                                        ...
                                        <option value="Ahmedabad" selected=""
                                            {{ old('village',$addmission->village) === 'Ahmedabad' ? 'selected' : '' }}>
                                            Ahmedabad
                                        </option>
                                        <option value="Anjar" {{ old('village',$addmission->village) === 'Anjar' ? 'selected' : '' }}>
                                            Anjar
                                        </option>
                                        <option value="Asambiya" {{ old('village',$addmission->village) === 'Asambiya' ? 'selected' : '' }}>
                                            Asambiya
                                        </option>
                                        <option value="Baladia" {{ old('village',$addmission->village) === 'Baladia' ? 'selected' : '' }}>
                                            Baladia
                                        </option>
                                        <option value="Bharapur" {{ old('village',$addmission->village) === 'Bharapur' ? 'selected' : '' }}>
                                            Bharapur
                                        </option>
                                        <option value="Bharasar" {{ old('village',$addmission->village) === 'Bharasar' ? 'selected' : '' }}>
                                            Bharasar
                                        </option>
                                        <option value="Bhuj" {{ old('village',$addmission->village) === 'Bhuj' ? 'selected' : '' }}>
                                            Bhuj
                                        </option>
                                        <option value="Dahisara" {{ old('village',$addmission->village) === 'Dahisara' ? 'selected' : '' }}>
                                            Dahisara
                                        </option>
                                        <option value="Don" {{ old('village',$addmission->village) === 'Don' ? 'selected' : '' }}>
                                            Don
                                        </option>
                                        <option value="Durgapar" {{ old('village',$addmission->village) === 'Durgapar' ? 'selected' : '' }}>
                                            Durgapar
                                        </option>
                                        <option value="Fotdi" {{ old('village',$addmission->village) === 'Fotdi' ? 'selected' : '' }}>
                                            Fotdi
                                        </option>
                                        <option value="Godhra" {{ old('village',$addmission->village) === 'Godhra' ? 'selected' : '' }}>
                                            Godhra
                                        </option>
                                        <option value="Godpar" {{ old('village',$addmission->village) === 'Godpar' ? 'selected' : '' }}>
                                            Godpar
                                        </option>
                                        <option value="Goniyasar" {{ old('village',$addmission->village) === 'Goniyasar' ? 'selected' : '' }}>
                                            Goniyasar
                                        </option>
                                        <option value="Haripur" {{ old('village',$addmission->village) === 'Haripur' ? 'selected' : '' }}>
                                            Haripur
                                        </option>
                                        <option value="Jakhaniya" {{ old('village',$addmission->village) === 'Jakhaniya' ? 'selected' : '' }}>
                                            Jakhaniya
                                        </option>
                                        <option value="Kera" {{ old('village',$addmission->village) === 'Kera' ? 'selected' : '' }}>
                                            Kera
                                        </option>
                                        <option value="Koday" {{ old('village',$addmission->village) === 'Koday' ? 'selected' : '' }}>
                                            Koday
                                        </option>
                                        <option value="Kodki" {{ old('village',$addmission->village) === 'Kodki' ? 'selected' : '' }}>
                                            Kodki
                                        </option>
                                        <option value="Kundanpar" {{ old('village',$addmission->village) === 'Kundanpar' ? 'selected' : '' }}>
                                            Kundanpar
                                        </option>
                                        <option value="Madhapar" {{ old('village',$addmission->village) === 'Madhapar' ? 'selected' : '' }}>
                                            Madhapar
                                        </option>
                                        <option value="Mandvi" {{ old('village',$addmission->village) === 'Mandvi' ? 'selected' : '' }}>
                                            Mandvi
                                        </option>
                                        <option value="Mankuva" {{ old('village',$addmission->village) === 'Mankuva' ? 'selected' : '' }}>
                                            Mankuva
                                        </option>
                                        <option value="Maska" {{ old('village',$addmission->village) === 'Maska' ? 'selected' : '' }}>
                                            Maska
                                        </option>
                                        <option value="Meghpar" {{ old('village',$addmission->village) === 'Meghpar' ? 'selected' : '' }}>
                                            Meghpar
                                        </option>
                                        <option value="Merau" {{ old('village',$addmission->village) === 'Merau' ? 'selected' : '' }}>
                                            Merau
                                        </option>
                                        <option value="Mirjapar" {{ old('village',$addmission->village) === 'Mirjapar' ? 'selected' : '' }}>
                                            Mirjapar
                                        </option>
                                        <option value="Nagalpur" {{ old('village',$addmission->village) === 'Nagalpur' ? 'selected' : '' }}>
                                            Nagalpur
                                        </option>
                                        <option value="Naranpur" {{ old('village',$addmission->village) === 'Naranpur' ? 'selected' : '' }}>
                                            Naranpur
                                        </option>
                                        <option value="Rampar" {{ old('village',$addmission->village) === 'Rampar' ? 'selected' : '' }}>
                                            Rampar
                                        </option>
                                        <option value="Rayan" {{ old('village',$addmission->village) === 'Rayan' ? 'selected' : '' }}>
                                            Rayan
                                        </option>
                                        <option value="Samatra" {{ old('village',$addmission->village) === 'Samatra' ? 'selected' : '' }}>
                                            Samatra
                                        </option>
                                        <option value="Sarli" {{ old('village',$addmission->village) === 'Sarli' ? 'selected' : '' }}>
                                            Sarli
                                        </option>
                                        <option value="Shirva" {{ old('village',$addmission->village) === 'Shirva' ? 'selected' : '' }}>
                                            Shirva
                                        </option>
                                        <option value="Sukhpar - Junavas"
                                            {{ old('village',$addmission->village) === 'Sukhpar - Junavas' ? 'selected' : '' }}>
                                            Sukhpar - Junavas
                                        </option>
                                        <option value="Sukhpar - Madanpur"
                                            {{ old('village',$addmission->village) === 'Sukhpar - Madanpur' ? 'selected' : '' }}>
                                            Sukhpar - Madanpur
                                        </option>
                                        <option value="Sukhpar - Roha"
                                            {{ old('village',$addmission->village) === 'Sukhpar - Roha' ? 'selected' : '' }}>
                                            Sukhpar - Roha
                                        </option>
                                        <option value="Surajpur" {{ old('village',$addmission->village) === 'Surajpur' ? 'selected' : '' }}>
                                            Surajpur
                                        </option>
                                        <option value="Vadasar" {{ old('village',$addmission->village) === 'Vadasar' ? 'selected' : '' }}>
                                            Vadasar
                                        </option>
                                        <option value="Vekra" {{ old('village',$addmission->village) === 'Vekra' ? 'selected' : '' }}>
                                            Vekra
                                        </option>
                                    </select>
                            ...
                            <div class="col-sm-4">
                                <div class="form-floating form-floating-outline ">
                                    <input type="number" class="form-control" id="adhaar_number"
                                        ...
                                        pattern="\d{12}" value="{{ old('adhaar_number',$addmission->adhaar_number) }}">
                            ...
                            <div class="col-sm-4">
                                <div class="form-floating form-floating-outline ">
                                    <input type="text" class="form-control" id="nationality"
                                        placeholder="Nationality" name="nationality" value="{{ old('nationality',$addmission->nationality) }}">
                            ...
                            <div class="col-sm-4">
                                <label class="switch ">
                                    <input type="checkbox" class="switch-input" name="is_any_illness"
                                        {{ old('is_any_illness',$addmission->is_any_illness) ? 'checked' : '' }} value="1" />
                            ...
                            <div class="col-sm-4 student_illness_field">
                                <div class="form-floating form-floating-outline ">
                                    <input type="text" class="form-control" id="basic-default-last_name"
                                        ...
                                        value="{{ old('illness_description',$addmission->illness_description) }}">
                                ...
                                <div class="col mt-2">
                                    <div class="form-check form-check-inline">
                                        <input name="vehicle" class="form-check-input" type="radio" id="vehicle"
                                            value="1" value="{{ old('vehicle',$addmission->vehicle) }} "/>
                                        <label class="form-check-label" for="vehicle">Yes</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input name="vehicle" class="form-check-input" type="radio" id="vehicle"
                                            value="0" checked value="{{ old('vehicle',$addmission->vehicle) }}"/>
                                ...
                                <div class="col mt-2">
                                    <div class="form-check form-check-inline">
                                        <input name="is_have_helmet" class="form-check-input" type="radio"
                                            value="1" id="helmet" value="{{ old('is_have_helmet',$addmission->is_have_helmet) }}"/>
                                        <label class="form-check-label" for="is_have_helmet">Yes</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input name="is_have_helmet" class="form-check-input" type="radio"
                                            value="0" id="helmet" value="{{ old('is_have_helmet',$addmission->is_have_helmet) }}"/>
                            ...
                            <div class="col-sm-4 vehicle_details">
                                <div class="form-floating form-floating-outline ">
                                    <input type="text" class="form-control" id="nationality"
                                        ...
                                        value="{{ old('vehicle_number',$addmission->vehicle_number) }}">
                            ...
                            <div class="col-sm-4">
                                <div class="form-floating form-floating-outline ">
                                    <input type="text" class="form-control" id="father_full_name"
                                        ...
                                        value="{{ old('father_full_name',$addmission->father_full_name) }}">
                            ...
                            <div class="col-sm-4">
                                <div class="form-floating form-floating-outline ">
                                    <input type="number" class="form-control" id="father_phone"
                                        ...
                                        pattern="\d{10}" value="{{ old('father_phone',$addmission->father_phone) }}">
                            ...
                            <div class="col-sm-4">
                                <div class="form-floating form-floating-outline ">
                                    <input type="text" class="form-control" id="father_occupation"
                                        ...
                                        value="{{ old('father_occupation',$addmission->father_occupation) }}">
                            ...
                            <div class="col-sm-4">
                                <div class="form-floating form-floating-outline ">
                                    <input type="text" class="form-control" id="mother_full_name"
                                        ...
                                        value="{{ old('mother_full_name',$addmission->mother_full_name) }}">
                            ...
                            <div class="col-sm-4">
                                <div class="form-floating form-floating-outline ">
                                    <input type="number" class="form-control" id="mother_phone"
                                        ...
                                        pattern="\d{10}" value="{{ old('mother_phone',$addmission->mother_phone) }}">
                            ...
                            <div class="col-sm-4">
                                <div class="form-floating form-floating-outline ">
                                    <input type="text" class="form-control" id="mother_occupation"
                                        ...
                                        value="{{ old('mother_occupation',$addmission->mother_occupation) }}">
                            ...
                            <div class="col-sm-4">
                                <div class="form-floating form-floating-outline ">
                                    <input type="number" class="form-control" id="annual_income"
                                        ...
                                        value="{{ old('annual_income',$addmission->annual_income) }}">
                            ...
                            <div class="col-sm-4">
                                <div class="form-floating form-floating-outline ">
                                    <input type="text" class="form-control" id="guardian_name"
                                        ...
                                        value="{{ old('guardian_name',$addmission->guardian_name) }}">
                            ...
                            <div class="col-sm-4">
                                <div class="form-floating form-floating-outline ">
                                    <input type="text" class="form-control" id="guardian_relation"
                                        ...
                                        value="{{ old('guardian_relation',$addmission->guardian_relation) }}">
                            ...
                            <div class="col-sm-4">
                                <div class="form-floating form-floating-outline ">
                                    <input type="number" class="form-control" id="guardian_phone"
                                        ...
                                        pattern="\d{10}" value="{{ old('guardian_phone',$addmission->guardian_phone) }}">
                    ...
                    <div id="social-links-modern-vertical" class="content">
                        ...
                        <div class="row g-4">
                                ...
                                <div class="form-floating form-floating-outline ">
                                    <select class="form-select select2" id="course_id" name="course_id">
                                        ...
                                        @foreach ($course as $id => $item)
                                            <option value="{{ $id }}" {{ old('course_id',$addmission->course_id) === $id ? 'selected' : '' }}>{{ $item }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-sm-4">
                                <div class="form-floating form-floating-outline ">
                                    <select class="form-select select2" id="semester" name="semester">
                                        ...
                                        @foreach ($sem as $item)
                                            <option value="{{ $item }}" {{ old('semester',$addmission->semester) === $item ? 'selected' : '' }}>{{ $item }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-sm-4">
                                <div class="form-floating form-floating-outline ">
                                    <input type="text" class="form-control" id="institute_name"
                                        ...
                                        value="{{ old('institute_name',$addmission->institute_name) }}">
                                ...
                                <div class="form-floating form-floating-outline ">
                                    <select class="form-select select2" id="year_of_addmission"
                                        ...
                                        @foreach ($year as $id => $item)
                                            <option value="{{ $item }}"  {{ old('year_of_addmission',$addmission->year_of_addmission) === $item ? 'selected' : '' }}>{{ $item }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-sm-4">
                                <div class="form-floating form-floating-outline ">
                                    <input class="form-control flatpickr-validation flatpickr-input flatpickr-mobile" type="date" value="{{ old('addmission_date',$addmission->addmission_date) }}"
                            ...
                            <div class="col-sm-4">
                                <div class="form-floating form-floating-outline ">
                                    <input class="form-control" type="time" name="college_start_time"
                                        id="college_start_time"  value="{{ old('college_start_time',$addmission->college_start_time) }}"/>
                            ...
                            <div class="col-sm-4">
                                <div class="form-floating form-floating-outline">
                                    <input class="form-control" type="time" name="college_end_time"
                                        id="college_end_time"  value="{{ old('college_end_time',$addmission->college_end_time) }}"/>
                            ...
                            <div class="col-sm-4">
                                <div class="form-floating form-floating-outline ">
                                    <input type="text" class="form-control" id="college_fees_receipt_no"
                                        ...
                                        value="{{ old('college_fees_receipt_no',$addmission->college_fees_receipt_no) }}">
                            ...
                            <div class="col-sm-4">
                                <div class="form-floating form-floating-outline ">
                                    <input class="form-control" type="date"
                                        value="{{ old('college_fees_receipt_date',$addmission->college_fees_receipt_date) }}" name="college_fees_receipt_date"
                            ...
                            <div class="col-sm-4">
                                <div class="form-floating form-floating-outline ">
                                    <input class="form-control" type="date"  value="{{ old('arriving_date',$addmission->arriving_date) }}"
                                                ...
                                                <div class="form-floating form-floating-outline">
                                                    <select class="form-select" id="doctype" name="doctype">
                                                        ...
                                                        @foreach ($doc as $id => $item)
                                                            <option value="{{ $item }}"  {{ old('doctype',$addmission->doctype) === $item ? 'selected' : '' }}>{{ $item }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="mb-0 col-lg-6 col-xl-2 col-12">
                                                <div class="form-floating form-floating-outline">
                                                    <select class="form-select" id="result_Status" name="result_Status">
                                                        ...
                                                        <option value="pass" {{ old('result_Status',$addmission->result_Status) === 'pass' ? 'selected' : '' }}>Pass</option>
                                                        <option value="fail" {{ old('result_Status',$addmission->result_Status) === 'fail' ? 'selected' : '' }}>Fail</option>
                                                        <option value="backlogs" {{ old('result_Status',$addmission->result_Status) === 'backlogs' ? 'selected' : '' }}>Backlogs</option>
                                                        <option value="other" {{ old('result_Status',$addmission->result_Status) === 'other' ? 'selected' : '' }}>Other</option>
                                                    </select>
                                            ...
                                            <div class="mb-0 col-lg-6 col-xl-2 col-12">
                                                <div class="form-floating form-floating-outline">
                                                    <input type="text" class="form-control" id="percentile"
                                                        ...
                                                        value="{{ old('percentile',$addmission->percentile) }}">
