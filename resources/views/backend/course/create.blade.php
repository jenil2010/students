...
@section('content')
        ...
        <div class="col-md">
                ...
                <div class="card-body">
                    <form novalidate="" action="{{ route('course.store') }}" method="POST">
                        ...
                        <div class="form-floating form-floating-outline mb-7">
                            <input type="text" class="form-control" id="bs-validation-courseName" name="course_name"
                                required="" value="{{ old('course_name') }}">
            ...
            @enderror</small>
                        ...
                        <div class="form-floating form-floating-outline mb-7">
                            <input type="text" id="bs-validation-email" class="form-control" name="duration"
