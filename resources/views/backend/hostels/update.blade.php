    ...
    {{-- <div class="container-xxl d-flex"> --}}
        <div class="col-md">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="browser-default-validation" action="{{ route('hostel.update',$hostel->id) }}" method="POST">
                        @csrf
                        <div class="form-floating form-floating-outline mb-6">
                            <input type="text" class="form-control" id="basic-default-name" placeholder="Hostel Name"
                            required="" name="hostel_name" value="{{old('hostel_name',$hostel->hostel_name)}}">
                        ...
                        <div class="form-floating form-floating-outline mb-6">
                            <textarea class="materialize-textarea form-control h-px-75 resize-none" id="basic-default-bio" name="location"
                                placeholder="Address" rows="3" required=""  >{{old('location',$hostel->location)}}</textarea>
                        ...
                        <div class="form-floating form-floating-outline mb-6">
                            ...
                            required="" name="contact_number" maxlength="10" pattern="\d{10}"  value="{{old('contact_number',$hostel->contact_number)}}">
                        ...
                        <div class="form-floating form-floating-outline mb-6">
                            <input type="number" class="form-control" id="basic-default-name" placeholder="Mobile Number"
                                required="" name="mobile_number" maxlength="10" pattern="\d{10}"  value="{{old('mobile_number',$hostel->mobile_number)}}">
                            ...
                            <div class="form-floating form-floating-outline mb-6">
                                <select class="form-select" id="basic-default-country" required="" name="status">
                                    ...
                                    <option value="1" {{old('status',$hostel->status) === 1? 'selected' : ''}}>Enable</option>
                                    <option value="0" {{old('status',$hostel->status) === 0? 'selected' : ''}}>Disable</option>
                                </select>
