...
@section('content')
    ...
    <div class="card h-100">
        <div class="card-header flex-column flex-md-row border-bottom">
            ...
            {{-- <form action="{{ route('report.allotedStuent') }}" method="post"> --}}
                        ...
                        columns: [{
                            ...
                            },
                            {
                                ...
                                render: function(data, type, full, meta) {
                                        var bedUrl = '{{ route('beds.release', 'id') }}'.replace('id',
                                        full.addmission_id);
                                        console.log(full.addmission_id);
                                        return (
                                        `<button><a href='${bedUrl}' class="dropdown-item text-danger delete-record">Release Bed</a></button>`
                                    );
                                }
                            }
                        ],
