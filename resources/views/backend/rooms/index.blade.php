    ...
    <div class="card h-100">
        <div class="card-header flex-column flex-md-row border-bottom">
            <div class="card-header d-flex align-items-center justify-content-between">
                <h5 class="card-title m-0 me-2 text-secondary">Rooms</h5>
                <a href="{{ route('rooms.create') }}" class="btn btn-primary"><i class="mdi mdi-plus me-sm-1"></i><span
                        class="d-none d-sm-inline-block">Rooms</span></a>
            </div>
            <hr>
                    ...
                    var dataTable = $('#warden').DataTable({
                        ...
                        columns: [{
                            ...
                            },
                            {
                                ...
                                orderable: false,
                                render: function(data, type, full, meta) {
                                    var editUrl = '{{ route('rooms.edit', 'id') }}'.replace('id', full
                                        .id);
                                    console.log(editUrl);
                                    var deleteUrl = '{{ route('rooms.delete', 'id') }}'.replace('id',
                                        full.id);
                                    return (
