    ...
    <div class="container-xxl d-flex">
        <div class="col-md">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="browser-default-validation" action="{{ route('rooms.update',$id) }}" method="POST">
                        @csrf
                        ...
                        <div class="form-floating form-floating-outline mb-6">
                            ...
                            required="" name="room_number" value="{{old('room_number',$rooms->room_number)}}">
                            ...
                            <div class="form-floating form-floating-outline mb-6">
                                <select class="form-select" id="basic-default-country" required="" name="status">
                                    ...
                                    <option value="1" {{old('status',$rooms->status) === 1? 'selected' : ''}}>Enable</option>
                                    <option value="0" {{old('status',$rooms->status) === 0? 'selected' : ''}}>Disable</option>
                                </select>
