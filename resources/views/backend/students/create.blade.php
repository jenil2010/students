        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('students.store') }}" method="POST">
                    @csrf
                    <div class="std-grid gap-4 mb-6">

                        <div class="form-floating form-floating-outline ">
                            <input type="text" class="form-control" id="basic-default-first_name"
                        ...
                        <div class="form-floating form-floating-outline ">
                            <input type="text" class="form-control" id="basic-default-middle_name"
                                placeholder="First Name" name="middle_name" value="{{ old('middle_name') }}">
                    ...
                    <div class="mb-3">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="basic-default-checkbox"
                                name="is_any_illness" value="1"
                                {{ old('is_any_illness', false) ? 'checked' : '' }} />
